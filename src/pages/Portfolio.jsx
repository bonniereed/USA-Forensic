...
export default function Portfolio() {
  ...
  return (
    <>
      ...
      {/* Desktop: tab bar + single active profile */}
      <div className="portfolio-tabbed">
      ...
      <div className="portfolio-stacked">
        {TABS.map((key) => (
          <div key={key} className="portfolio-stacked__profile">
            <ProfileCard person={portfolioData[key]} />
          </div>
        ))}
      </div>
